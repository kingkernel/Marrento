...
class index {
	...
	public function index()
	{
		...
		{
			$campos = ["cssinterface" => "public/css/bootstrap/4.0.0-alpha.4/bootstrap.min.css", "cssbootstrap", "javascript-interface" => "public/js/bootstrap/4.0.0-alpha.4/bootstrap.min.js", "jslibrary" => '<script type="text/javascript" src="public/js/jquery/3.3.1/jquery-3.3.1.slim.min.js"></script>'];
